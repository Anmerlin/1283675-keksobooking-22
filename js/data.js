...
const DESCRIPTION_OFFER = [
  'Superior apartment overlooking the park',
  'A spacious palace where you can get lost',
  'Two-storey house with vegetable garden and garage',
  'Bungalow blown by all the winds',
];
const PHOTOS_OFFER = [
...
const createAnnouncement = () => {
  ...
  return {
    ...
    offer: {
      ...
      rooms: getRandomNumberRangeInclusive(1, 11), //число — количество комнат. Любое положительное число.
      guests: getRandomNumberRangeInclusive(1, 21), // число — количество гостей, которое можно разместить. Любое положительное число.
